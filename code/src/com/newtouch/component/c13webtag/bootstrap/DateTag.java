		...
		try {
			...
			if(this.getReadonly()==null||this.getReadonly()=="false"){
                if (this.getDateFormat() != null && !"".equals(this.getDateFormat())) {
                    ...
                    TransHelper.stringBufferAppender(sbf,"    <div class='controls'><input type='text' class='input-medium ",this.getIclass(),"' iclass='' onClick='WdatePicker()' name='",this.getName(),"' id='",this.getId(),"' value='",this.getValue(),"'  ></div>");
                }
			}else{
