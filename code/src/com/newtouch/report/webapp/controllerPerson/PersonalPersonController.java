package com.newtouch.report.webapp.controllerPerson;
...
@Controller
public class PersonalPersonController extends BaseController {
	...
	@RequestMapping("/ReportPerson/Download.do")
	public ModelAndView Login(HttpServletRequest req, HttpServletResponse res) {
		req.setAttribute("rmHelper", new ReturnMsgHelper(req, new ReturnMsg(), new PageCount(), true));

		return new ModelAndView("ca/cacore/personalPerson/personal");
	}
	/**
	 * 
	 *查看
	 */
	@RequestMapping("/reportPerson/personalPerson/queryreport.do")
	...
	//下载
	@RequestMapping("/ReportPerson/DownloadExcel.do")
	...
	@RequestMapping("/personalPerson/goquerysysbranch.do")
	public ModelAndView goquerysysbranch(HttpServletRequest req, HttpServletResponse res) {
		...
		if ("M".equals(date_flag)) {
			jsp_path = "ca/cacore/personalPerson/sysbranchcommission_month";
		}else {
			jsp_path = "ca/cacore/personalPerson/sysbranchcommission";
		}
	...
	@RequestMapping("/personalPerson/sysbranchcommission.do")
	public ModelAndView sysbranchcommission(HttpServletRequest req, HttpServletResponse res) {
		...
		Sysbranchcommissionimpl commission = new Sysbranchcommissionimpl("1");
		commission.setBranch_id(branch_id);
		commission.setTerm_date(term_date);
		commission.setDate_flag(date_flag);
		commission.setPerson_flag(person_flag);
...
//		}
	...
	@RequestMapping("/personalPerson/downloadsysbranchcommission.do")
	public ModelAndView downloadsysbranchcommission(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Sysbranchcommission commission = new Sysbranchcommissionimpl("1");
		commission.setBranch_id(branch_id);
		commission.setTerm_date(term_date);
		commission.setDate_flag(date_flag);
		commission.setCreateUser(user.getEmp_id());
...
//		}
		this.downloadcommissionPerson(returnMsg, req, res);
		return null;
	}
	...
	@RequestMapping("/personalPerson/goquerysysagency.do")
	public ModelAndView goquerysysagency(HttpServletRequest req, HttpServletResponse res) {
		req.setAttribute("rmHelper", new ReturnMsgHelper(req, new ReturnMsg(), new PageCount(), true));
		return new ModelAndView("ca/cacore/personalPerson/sysagencycommission");
	}
	...
	@RequestMapping("/personalPerson/sysagencycommission.do")
	public ModelAndView sysagencycommission(HttpServletRequest req, HttpServletResponse res) {
		...
		if (branch_id == null || "".equals(branch_id)) {
			returnMsg.setFailMessage("中介公司查询条件不能为空,请选择后查询。");
			req.setAttribute("rmHelper", new ReturnMsgHelper(req, returnMsg,  true));
			return returnPage(res, returnMsg, "ca/cacore/personalPerson/sysagencycommission");
		}
		if (term_date == null) {
			returnMsg.setFailMessage("时间查询条件不能为空,请选择后查询。");
			req.setAttribute("rmHelper", new ReturnMsgHelper(req, returnMsg,  true));
	...
	@RequestMapping("/personalPerson/downloadagencycommission.do")
	...
	@RequestMapping("/personalPerson/goquerycpybranch.do")
	public ModelAndView goquerycpybranch(HttpServletRequest req, HttpServletResponse res) {
		...
		req.setAttribute("rmHelper", new ReturnMsgHelper(req, new ReturnMsg(), new PageCount(), true));
		return new ModelAndView("ca/cacore/personalPerson/cpybranchcommission");
	}
	 ...
	 */
	@RequestMapping("/personalPerson/cpybranchcommission.do")
	public ModelAndView cpybranchcommission(HttpServletRequest req, HttpServletResponse res) {
		...
		if (branch_id == null || "".equals(branch_id)) {
			returnMsg.setFailMessage("中介公司查询条件不能为空,请选择后查询。");
			req.setAttribute("rmHelper", new ReturnMsgHelper(req, returnMsg,  true));
			return returnPage(res, returnMsg, "ca/cacore/personalPerson/cpybranchcommission");
		}
		/*
		 * if (cpybranch_id == null || "".equals(cpybranch_id)) {
		 * returnMsg.setFailMessage("保险公司查询条件不能为空,请选择后查询。");
		 * req.setAttribute("rmHelper", new ReturnMsgHelper(req, returnMsg, true));
		 * return returnPage(res, returnMsg,
		 * "ca/cacore/personalPerson/cpybranchcommission"); }
		 */
		if (term_date == null) {
			returnMsg.setFailMessage("时间查询条件不能为空,请选择后查询。");
			req.setAttribute("rmHelper", new ReturnMsgHelper(req, returnMsg,  true));
		...
		//commission.setPageCount(ActionHelper.getPage(req));// 分页
		Sysbranchcommission commission1 = new Sysbranchcommissionimpl("1");
	...
	@RequestMapping("/personalPerson/downloadcpybranchcommission.do")
...
//		}
	...
	@RequestMapping("/personalPerson/goqueryinsurance.do")
	public ModelAndView goqueryinsurance(HttpServletRequest req, HttpServletResponse res) {
		req.setAttribute("rmHelper", new ReturnMsgHelper(req, new ReturnMsg(), new PageCount(), true));
		String date_flag = ActionHelper.getNullToStr(req.getParameter("date_flag"));//日期标识
		String jsp_path = "";
		if ("M".equals(date_flag)) {
			jsp_path = "ca/cacore/personalPerson/insurancecommission_month";
		}else {
			jsp_path = "ca/cacore/personalPerson/insurancecommission";
		}
		return new ModelAndView(jsp_path);
	}
	...
	@RequestMapping("/personalPerson/insurancecommission.do")
...
//			returnMsg.setFailMessage("保险公司查询条件不能为空,请选择后查询。");
//			req.setAttribute("rmHelper", new ReturnMsgHelper(req, returnMsg,  true));
//			return returnPage(res, returnMsg, "ca/cacore/personalPerson/insurancecommission");
//		}
		if (term_date == null) {
			returnMsg.setFailMessage("时间查询条件不能为空,请选择后查询。");
			req.setAttribute("rmHelper", new ReturnMsgHelper(req, returnMsg,  true));
...
//		commission.setCpybranch_id(cpybranch_id);
	...
	@RequestMapping("/personalPerson/downloadinsurancecommission.do")
...
//		}
		...
		commission.setCreateUser(user.getEmp_id());
//		commission.setCpybranch_id(cpybranch_id);
		commission.setPageCount(ActionHelper.getPage(req));
	...
	public void downloadcommissionPerson(ReturnMsg returnMsg, HttpServletRequest req, HttpServletResponse res) throws Exception{
		HSSFWorkbook wb = new HSSFWorkbook(); // 定义一个新的工作簿
		HSSFSheet sheet = wb.createSheet("第一个Sheet页"); // 创建第一个Sheet页
		HSSFCellStyle cellStyle = wb.createCellStyle();
		cellStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER); // 居中
...
//		Sysbranchcommission commission = (Sysbranchcommission) map.get("collectcity");
		...
		for (int i = 0; i < commissionlist.size(); i++) {
			...
			entity1[1]      =  bigDecimalToString (commissionlist.get(i).getG_month_count         ());
			entity1[2]      =  bigDecimalToString( commissionlist.get(i).getG_month_amount        ());
			entity1[3]      =  bigDecimalToString( commissionlist.get(i).getG_month_premium       ());
			entity1[4]      =  bigDecimalToString( commissionlist.get(i).getG_month_fee           ());
			entity1[5]      =  commissionlist.get(i).getNewg_month_premium    ();
			entity1[6]      =  commissionlist.get(i).getNewg_month_fee();
			entity1[7]      =  bigDecimalToString( commissionlist.get(i).getG_year_count          ());
			entity1[8]      =  bigDecimalToString( commissionlist.get(i).getG_year_amount         ());
			entity1[9]      =  bigDecimalToString( commissionlist.get(i).getG_year_premium        ());
			entity1[10]     =  bigDecimalToString( commissionlist.get(i).getG_year_fee            ());
			entity1[11]     =  commissionlist.get(i).getNewg_year_premium     ();
			entity1[12]     =  commissionlist.get(i).getNewg_year_fee         ();
			entity1[13]     =  bigDecimalToString( commissionlist.get(i).getU_month_count         ());
			entity1[14]     =  bigDecimalToString( commissionlist.get(i).getU_month_amount        ());
			entity1[15]     =  bigDecimalToString( commissionlist.get(i).getU_month_premium       ());
			entity1[16]     =  bigDecimalToString( commissionlist.get(i).getU_month_fee           ());
			entity1[17]     =  bigDecimalToString( commissionlist.get(i).getU_year_count          ());
			entity1[18]     =  bigDecimalToString( commissionlist.get(i).getU_year_amount         ());
			entity1[19]     =  bigDecimalToString( commissionlist.get(i).getU_year_premium        ());
			entity1[20]     =  bigDecimalToString( commissionlist.get(i).getU_year_fee            ());
			entity1[21]     =  bigDecimalToString(commissionlist.get(i).getAll_month_count        ());
			entity1[22]     =  bigDecimalToString( commissionlist.get(i).getAll_month_amount      ());
			entity1[23]     =  bigDecimalToString( commissionlist.get(i).getAll_month_premium     ());
			entity1[24]     =  bigDecimalToString( commissionlist.get(i).getAll_month_fee         ());
			entity1[25]     =  bigDecimalToString( commissionlist.get(i).getAll_year_count        ());
			entity1[26]     =  bigDecimalToString( commissionlist.get(i).getAll_year_amount       ());
			entity1[27]     =  bigDecimalToString( commissionlist.get(i).getAll_year_premium      ());
			entity1[28]     =  bigDecimalToString( commissionlist.get(i).getAll_year_fee          ());
		...
		cell01.setCellValue("本月新保");
		cell01.setCellStyle(cellStyle);
		Cell cell02 = row.createCell(7);
		cell02.setCellValue("本年新保");
		cell02.setCellStyle(cellStyle);
		Cell cell03 = row.createCell(13);
		cell03.setCellValue("本月续期");
		cell03.setCellStyle(cellStyle);
		Cell cell04 = row.createCell(17);
		cell04.setCellValue("本年续期");
		cell04.setCellStyle(cellStyle);
		Cell cell05 = row.createCell(21);
		cell05.setCellValue("本月合计");
		cell05.setCellStyle(cellStyle);
		Cell cell06 = row.createCell(25);
		cell06.setCellValue("本年合计");
		...
		row1.createCell(	3	).setCellValue("保费");
		row1.createCell(	4	).setCellValue("新单手续费");
		row1.createCell(	5	).setCellValue("保费同期（+/-)");
		row1.createCell(	6	).setCellValue("新单费同期（+/-)");
		row1.createCell(	7	).setCellValue("承保数量");
		row1.createCell(	8	).setCellValue("保险金额");
		row1.createCell(	9	).setCellValue("保费");
		row1.createCell(	10	).setCellValue("新单手续费");
		row1.createCell(	11	).setCellValue("保费同期（+/-)");
		row1.createCell(	12	).setCellValue("续期手续费（+/-)");
		row1.createCell(	13	).setCellValue("承保数量");
		row1.createCell(	14	).setCellValue("保险金额");
		row1.createCell(	15	).setCellValue("保费");
		row1.createCell(	16	).setCellValue("续期手续费");
		row1.createCell(	17	).setCellValue("承保数量");
		row1.createCell(	18	).setCellValue("保险金额");
		row1.createCell(	19	).setCellValue("保费");
		row1.createCell(	20	).setCellValue("续期手续费");
		row1.createCell(	21	).setCellValue("承保数量");
		row1.createCell(	22	).setCellValue("保险金额");
		row1.createCell(	23	).setCellValue("保费");
		row1.createCell(	24	).setCellValue("手续费合计");
		row1.createCell(	25	).setCellValue("承保数量");
		row1.createCell(	26	).setCellValue("保险金额");
		row1.createCell(	27	).setCellValue("保费");
		row1.createCell(	28	).setCellValue("手续费合计");
