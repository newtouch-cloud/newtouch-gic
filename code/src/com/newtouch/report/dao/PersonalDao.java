...
public interface PersonalDao {
	...
	List<Sysbranchcommission> cpybranch_monthcommission(Sysbranchcommission commission);

	Sysbranchcommission collectcpybranch_month(Sysbranchcommission commission);

	List<Sysbranchcommission> downloadcpybranch_monthcommission(Sysbranchcommission commission);
