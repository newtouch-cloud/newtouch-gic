...
@Component("T_MenuDao")
public class T_MenuDao extends ServerBase implements IDao {
	private static List<String> clmList = new ArrayList<String>();
	private static List<String> baseList = new ArrayList<String>();
	static {
		clmList.add("menu_no");
		clmList.add("menu_name");
		clmList.add("menu_url");
		clmList.add("parent_no");
		clmList.add("menu_order");
		clmList.add("menu_type");
		clmList.add("menu_status");
		clmList.add("menu_seq");
		baseList.add("serno");
	...
	public int insert(Map<String, Object> param) {
		...
		String value = "?, ?, ?, ?, ?, ?";
		update.add(UniqueSeq.getUniqueSeq("serno", "t_menu"));
		...
		String sql = "INSERT INTO t_menu (" + clm + ") VALUES(" + value + ")";
		update.setSql(sql);
	...
	public int update(Map<String, Object> where, Map<String, Object> set) {
		...
		String sql = "UPDATE t_menu SET " + setClm + " " + whereClm;
		update.setSql(sql);
		return this.dbHandle().update(update);
	}
	...
	public int delete(Map<String, Object> where) {
		...
		String sql = "DELETE FROM t_menu " + whereClm;
		update.setSql(sql);
		return this.dbHandle().update(update);
	}
	...
	private boolean isContinue(String clmName) {
		if (T_MenuDao.clmList.contains(clmName)) {
			return true;
		}
		if (T_MenuDao.baseList.contains(clmName)) {
