...
@Component("T_DeptDao")
public class T_DeptDao extends ServerBase implements IDao {
	...
	static {
		...
		clmList.add("dept_no");
		clmList.add("dept_name");
		clmList.add("dept_type");
		clmList.add("dept_level");
		clmList.add("up_dept");
		clmList.add("start_date");
		clmList.add("end_date");
		clmList.add("status");
		clmList.add("order_seq");
		clmList.add("order_num");
		baseList.add("serno");
	...
	public int insert(Map<String, Object> param) {
		...
		String value = "?, ?, ?, ?, ?, ?";
		update.add(UniqueSeq.getUniqueSeq("serno", "t_dept"));
		...
		String sql = "INSERT INTO t_dept (" + clm + ") VALUES(" + value + ")";
		update.setSql(sql);
	...
	public int update(Map<String, Object> where, Map<String, Object> set) {
		...
		String sql = "UPDATE t_dept SET " + setClm + " " + whereClm;
		update.setSql(sql);
		return this.dbHandle().update(update);
	}
	...
	public Map<String, Object> query(Map<String, Object> param, boolean paginate) {
		return this.dbHandle().query(this.joinQuerySql(param, paginate));
	}

	@Override
	public List<Map<String, Object>> queryList(Map<String, Object> param,
			boolean paginate) {
		return this.dbHandle().queryList((this.joinQuerySql(param, paginate)));
	}
	...
	public int delete(Map<String, Object> where) {
		...
		String sql = "DELETE FROM t_dept " + whereClm;
		update.setSql(sql);
		return this.dbHandle().update(update);
	}
	...
	private boolean isContinue(String clmName) {
		if (T_DeptDao.clmList.contains(clmName)) {
			return true;
		}
		if (T_DeptDao.baseList.contains(clmName)) {
