...
@Component("T_Operator_RolesDao")
public class T_Operator_RolesDao extends ServerBase implements IDao {
	...
	public int insert(Map<String, Object> param) {
		...
		String value = "?, ?, ?, ?, ?, ?";
		update.add(UniqueSeq.getUniqueSeq("serno", "t_operator_roles"));
		...
		String sql = "INSERT INTO t_operator_roles (" + clm + ") VALUES(" + value + ")";
		update.setSql(sql);
	...
	public int update(Map<String, Object> where, Map<String, Object> set) {
		...
		String sql = "UPDATE t_operator_roles SET " + setClm + " " + whereClm;
		update.setSql(sql);
		return this.dbHandle().update(update);
	}
	...
	public int delete(Map<String, Object> where) {
		...
		String sql = "DELETE FROM t_operator_roles " + whereClm;
		update.setSql(sql);
		return this.dbHandle().update(update);
	}
	...
	private boolean isContinue(String clmName) {
		if (T_Operator_RolesDao.clmList.contains(clmName)) {
			return true;
		}
		if (T_Operator_RolesDao.baseList.contains(clmName)) {
	...
	private QuerySqlable joinQuerySql(Map<String, Object> param,
			boolean isPaginate) {
		String sql = "SELECT * FROM t_operator_roles ";
		String where = "";
