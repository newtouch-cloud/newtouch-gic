...
@Component("T_RolesDao")
public class T_RolesDao extends ServerBase implements IDao {
	private static List<String> clmList = new ArrayList<String>();
	private static List<String> baseList = new ArrayList<String>();
	static {
		clmList.add("role_no");
		clmList.add("role_name");
		clmList.add("role_type");
		clmList.add("dept_no");
		baseList.add("serno");
	...
	public int insert(Map<String, Object> param) {
		...
		String value = "?, ?, ?, ?, ?, ?";
		update.add(UniqueSeq.getUniqueSeq("serno", "t_roles"));
		...
		String sql = "INSERT INTO t_roles (" + clm + ") VALUES(" + value + ")";
		update.setSql(sql);
	...
	public int update(Map<String, Object> where, Map<String, Object> set) {
		...
		String sql = "UPDATE t_roles SET " + setClm + " " + whereClm;
		update.setSql(sql);
		return this.dbHandle().update(update);
	}
	...
	public int delete(Map<String, Object> where) {
		...
		String sql = "DELETE FROM t_roles " + whereClm;
		update.setSql(sql);
		return this.dbHandle().update(update);
	}
	...
	private boolean isContinue(String clmName) {
		if (T_RolesDao.clmList.contains(clmName)) {
			return true;
		}
		if (T_RolesDao.baseList.contains(clmName)) {
