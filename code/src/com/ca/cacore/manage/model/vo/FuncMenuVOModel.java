 ...
 * 
 */
public class FuncMenuVOModel implements IFuncMenuVOModel{
...
//	private List
	...
	List<IFuncButtonVOModel> fbms = new ArrayList<IFuncButtonVOModel>();
	
	public FuncMenuVOModel(Integer seq_id){
		this.seq_id=seq_id;
	}
	public FuncMenuVOModel(){
	}
	...
	public List<IFuncButtonVOModel> getFbms() {
		return fbms;
	}
	public void setFbms(List<IFuncButtonVOModel> fbms) {
		this.fbms = fbms;
	}
