 ...
 * @author Wangds
 * @since 2013-12-4
 * @description PDT_Product_Charge_Type 产品可选缴费方式';
 */
public class ProductChargeTypeModel implements IProductChargeTypeModel {
	...
	public ProductChargeTypeModel() {
	}
	public ProductChargeTypeModel(String product_id) {
