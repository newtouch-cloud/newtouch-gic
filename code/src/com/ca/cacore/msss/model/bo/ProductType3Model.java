 ...
 * @author Wangds
 * @since 2013-12-9
 * @description PDT_Product_Type3 产品分类3数据字典（财务对接用）
 */
public class ProductType3Model implements IProductType3Model   {
	
	private Integer seq_id; // 主键
	private String product_type_code; // 产品类型3代码
	private String product_type_name; // 产品类型3名称
