 ...
 * @author Wang_ds
 * @since 2013-12-4
 * @description  PDT_Pkg_Life  寿险产品组合信息
 */
public class PkgLifeModel implements IPkgLifeModel  {
	
	
	private Integer seq_id; // 主键
	private String pkg_id; // 险种代码
	private String pkg_name; // 产品名称
	private String pkg_abbr; // 产品简称
	private String pkg_enName; //产品英文名称
	private String pkg_enAbbr; //产品英文简称
