 ...
 * @author Wangds
 * @since 2013-12-9
 * @description PDT_Product_Type2 产品分类2数据字典	
 */
public class ProductType2Model implements IProductType2Model  {
	
	private Integer seq_id; // 主键
	private String product_type_code; // 产品类型2代码
	private String product_type_name; // 产品类型2名称
