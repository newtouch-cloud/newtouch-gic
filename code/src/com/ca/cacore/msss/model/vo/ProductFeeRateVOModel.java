...
*/
public class ProductFeeRateVOModel implements IProductFeeRateVOModel    {
	...
	private String coverage_period; // 保障期限类型代码
	private String coverage_period_name; // 保障期限类型名称
	private String coverage_year; //保障年数
	private String sell_way; // 销售方式代码
	private String sell_way_name; // 销售方式名称
	private String charge_type; // 缴费方式代码
	...
	public ProductFeeRateVOModel() {
	}
	
	public ProductFeeRateVOModel(Integer seq_id) {
		this.seq_id = seq_id;
	}
