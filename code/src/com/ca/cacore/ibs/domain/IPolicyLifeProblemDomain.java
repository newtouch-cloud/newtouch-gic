...
public interface IPolicyLifeProblemDomain {
	public List<IPolicyLifeProblemModel> queryPolicyLifeProblem(IPolicyLifeProblemModel model);//查询所有问题件信息
	
	public IPolicyLifeProblemModel getPolicyLifeProblemInfo(IPolicyLifeProblemModel model);//查询某个问题件信息
	...
	public IPolicyLifeProblemModel getInfo(IPolicyLifeProblemModel model);//问题件录入时查询要带出信息
	
	/**
	* @param model
	* @return IPolicyLifeProblemModel
	* @description:理赔和保全时候带出信息
	 */
