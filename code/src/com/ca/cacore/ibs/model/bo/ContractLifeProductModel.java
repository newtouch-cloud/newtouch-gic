...
public class ContractLifeProductModel  implements IContractLifeProductModel{
	...
	private String	insurant_id;//被保人	
	...
	private String	product_type3	;//产品分类3（保障类型，财务用） ？？？没有此字段后备使用
	private String	policy_code	;//保单号码 ？？？没有此字段后备使用
