...
/**
 * @description:寿险投保单受益人信息
 * 对应的数据库表：CBS_PolicyLife_Beneficiary
 * @author xxz521
 *@since 2013/12/05
 */
public class PolicyLifeBeneficiaryModel implements IPolicyLifeBeneficiaryModel {
	...
	public PolicyLifeBeneficiaryModel(){}
	
	public PolicyLifeBeneficiaryModel(Integer seq_id){
		this.seq_id = seq_id;
	}
