...
public class ContractLifeSaveVOModel {
	...
	public ContractLifeHolderModel  holderModel  ;//投保人集合
	public IPolicyImageModel policyImageModel ;//影像上传集合
	public List<ContractLifeInsurantModel>insurantList = new ArrayList<ContractLifeInsurantModel>();//被保人集合
	public List<ContractLifeBeneficiaryModel>beneficiaryList = new ArrayList<ContractLifeBeneficiaryModel>();//受益人集合
	public List<ContractLifeProductVOModel>productListView = new ArrayList<ContractLifeProductVOModel>();//险种集合
	...
	private String service_id; // 保单服务人 员 REF:SMIS_Sales
    ...
    private Double fee;//手续费
	 ...
	 private String inner_policy_code;//内部保单号码
	...
	public ContractLifeHolderModel getHolderModel() {
		return holderModel;
	}
	public void setHolderModel(ContractLifeHolderModel holderModel) {
		this.holderModel = holderModel;
	}
	public List<ContractLifeInsurantModel> getInsurantList() {
		return insurantList;
	}
	public void setInsurantList(List<ContractLifeInsurantModel> insurantList) {
		this.insurantList = insurantList;
	}
	public List<ContractLifeBeneficiaryModel> getBeneficiaryList() {
		return beneficiaryList;
	}
	public void setBeneficiaryList(
			List<ContractLifeBeneficiaryModel> beneficiaryList) {
		this.beneficiaryList = beneficiaryList;
	}
	public List<ContractLifeProductVOModel> getProductListView(){
		return productListView;
	}
	public void setProductListView(List<ContractLifeProductVOModel> productList) {
	...
	public void setInsurantListView(List<IContractLifePeopleVOModel> insurantListView) {
	...
	public void setBeneficiaryListView(List<IContractLifePeopleVOModel> beneficiaryListView) {
		this.beneficiaryListView = beneficiaryListView;
	}
	public String getInner_policy_code() {
		return inner_policy_code;
	}
	public void setInner_policy_code(String inner_policy_code) {
		this.inner_policy_code = inner_policy_code;
	}
}
