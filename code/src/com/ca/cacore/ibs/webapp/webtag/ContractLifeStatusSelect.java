 ...
 */
@Service
public class ContractLifeStatusSelect extends ServerBase implements IDynamicSelectDataSupport{
	...
	public List<IDynamicSelectData> getData() {
		...
		List<PolicyStatusModel> list = policyStatusDomain.queryContractLifeStatus();
