...
* @since:    2013年12月10日   
* @author  xxz
* @description:投保人与主被保人关系动态标签：answerTypeSelect
 */
@Service
public class ApplicantRelation1Select extends ServerBase implements IDynamicSelectDataSupport{
	...
	public List<IDynamicSelectData> getData() {
		...
		List<ApplicantRelation2Model> list = applicantRelation2Domain.queryApplicantRelation1();
