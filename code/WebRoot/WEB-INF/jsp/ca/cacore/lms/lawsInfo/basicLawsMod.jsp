...
<html lang="en">
	...
	<body>
		<div class="container-fluid" >
			...
			<!--增加面板 start -->
			<div class="row-fluid">
				<form id="mainForm" name="mainForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/LMS/BasicLawsManager/modBasicLaws.do" method="POST">
					<!-- 提示信息 -->
					...
					<fieldset>
					<div class="row">
						<webTag:DynamicSelectTag src="channelInfoSelect" name="dept_type" id="dept_type" value='${rmHelper.returnParams.dept_type}' displayLable="渠道类型"></webTag:DynamicSelectTag>
