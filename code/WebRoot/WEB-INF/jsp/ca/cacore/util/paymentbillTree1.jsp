...
<script type="text/javascript">
    ...
    function onClick(e, treeId, treeNode) {
        ...
        var cpybranch_name=$("#cpybranch_name").val();
   		//alert(cpybranch_name);
   		if(cpybranch_name == ""){
   			$("#management").attr("readonly",true);//赋值
   		}else{
   			$("#management").removeAttr("readonly");//赋值
   		}
    }
...
<div style="margin-left:20px" class='control-group span4'>
    <label class='control-label' for='cpybranch_name'>保险公司机构选择</label>
    <div class='controls'>
        <input type='text' onclick='getcpyOrgTree();' class='input-medium back_image cpybranch_name tooltip-hide' name='cpybranch_name'
