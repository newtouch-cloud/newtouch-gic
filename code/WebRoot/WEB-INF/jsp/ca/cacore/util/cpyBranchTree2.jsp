...
<script type="text/javascript">
    ...
    function getOrgTree() {
        $.ajax({
            type: "POST",
            url: "<%=basePath %>/mass/queryCpyBranchTree2.do?rqstType=AJAX",
            async: false,
...
<div style="margin-left:0px" class='control-group span4'>
    <label class='control-label' for='branch_name'>保险公司机构</label>
    <div class='controls'>
    ...
    <input type="hidden" id="org_level" name="org_level" value='1'/>
    </div>
</div>
