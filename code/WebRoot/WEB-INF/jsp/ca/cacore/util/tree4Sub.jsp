	...
	<body style="margin-top: 0px; margin-left: 0px;">
  		<form name="submitForm" method="post" action="leftMenu" target="rightFrame">
  			<div>
  				...
  				&nbsp;&nbsp;&nbsp;&nbsp;
  				是否包含下级：			
  				<select id="is4Sub" name="is4Sub" style="width:80px" >
