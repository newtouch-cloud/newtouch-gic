...
<div style="margin-left:0px"  class='control-group span4'>
	<label   class='control-label' for='branch_name'>财险公司机构(<font color="red">*</font>)：</label>
	<div class='controls' >
	
		<input type='text' onclick='cpygetOrgTree();'  class='input-medium back_image cpybranch_name' name='cpybranch_name' readonly id='cpybranch_name'  value='${rmHelper.returnMsg.dataTable.org_name}'/>
		<input type="hidden" id="cpybranch_id" name="cpybranch_id" value='${rmHelper.returnMsg.dataTable.org_id}'/>
	</div>
</div>
