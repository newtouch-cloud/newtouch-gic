...
<div style="margin-left:0px"  class='control-group span4'>
	<label   class='control-label' for='branch_name'>中介公司机构(<font color="red">*</font>):</label>
	<div class='controls' >
		<input type='text' onclick='getOrgTree();'   class='input-medium back_image branch_name' name='branch_name' readonly id='branch_name'  value='${rmHelper.returnMsg.dataTable.branch_name}'/>
		<input type="hidden" id="branch_id" name="branch_id" value='${rmHelper.returnMsg.dataTable.branch_id}'/>
	</div>
</div>
