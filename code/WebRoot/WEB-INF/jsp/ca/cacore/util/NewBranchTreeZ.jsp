...
<script type="text/javascript">
    ...
    function getOrgTree() {
        ...
        $.ajax({
            type: "POST",
            url: "<%=basePath %>/sms/querySalesFirmBranchTreeZ.do?rqstType=AJAX&path=1&branchid=" + branchid,
            async: true,
            data:{},
    ...
    function zTreeOnExpand(event, treeId, treeNode) {
        ...
        $.ajax({
            type: "POST",
            url: "<%=basePath %>/sms/querySalesFirmBranchTreeZ.do?rqstType=AJAX&path=2&org_level=" + level + "&branchid=" + branchid,
            async: false,
            success: function (data) {
                var zTree = $.fn.zTree.getZTreeObj("treeDemo");
                var zNodes = JSON.parse(data).retList;
