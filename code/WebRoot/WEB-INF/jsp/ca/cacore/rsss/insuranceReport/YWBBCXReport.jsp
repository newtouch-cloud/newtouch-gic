	...
	<body>
		<div class="container-fluid" >
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i>保险代理机构业务报表-产险</span>
			...
			<div class="row-fluid" id="Shrinkcontent1">
                    ...
                    <webTag:HiddenInputTag id="reportType" name="reportType"  value='YWBBCX'></webTag:HiddenInputTag>
					
					<div class="row" >
						<webTag:Text name="reportType4" id="reportType4" value='保险代理机构业务报表-产险' displayLable="报表类型" isdisplay="true" readonly="true"/>
					</div>
...
<%-- 						<jsp:include page="branchTreeRequired.jsp" flush="true"/> --%>
				...
				<form id="exportForm" action="<%=basePath %>/rfm/InsCompanyBus/exportInsCompanyBus.do" method="POST">
					<webTag:HiddenInputTag id="reportType" name="reportType"  value='${reportType }'></webTag:HiddenInputTag>
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					<thead>
						<tr>
							...
							<th  style="text-align:center;">保费金额</th>
							<th  style="text-align:center;">应付金额(未解付保费)</th>
							<th  style="text-align:center;">代理佣金</th>
						</tr>
						<tr>
							<th>累计</th>
							<th>期末数</th>
