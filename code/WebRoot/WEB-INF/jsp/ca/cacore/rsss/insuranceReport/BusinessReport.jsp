...
<html lang="en">
	<head>
        ...
        <script >    
			var linkUrl = "<%=basePath %>/RFM/BusinessReport/queryBusinessReport.do";
	...
	<body>
		<div class="container-fluid" >
			...
			<div class="row-fluid" id="Shrinkcontent1">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/RFM/BusinessReport/queryBusinessReport.do" method="POST">
					...
					<div class="row" style="text-align:right;">
				      		<button type="submit" class="btn btn-danger" onClick="checkVule();" ><i class="icon-search icon-white"></i>查询</button>
