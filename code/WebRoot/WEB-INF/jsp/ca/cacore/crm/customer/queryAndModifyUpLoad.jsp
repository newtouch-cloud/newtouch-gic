...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i> 客户信息导入</span>
			...
			<div class="row-fluid" id="Shrinkcontent1">
				...
				<webTag:HiddenInputTag id="protocol_category" name="protocol_category" value='3'/>
				<div class="overAuto row-fluid">
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						...
						<tr>
							<td colspan="5" style="vertical-align: middle; text-align: right;"><a class="btn btn-danger" href="<%=basePath %>/CRM/Customer/toAddAndModifyCustomer.do"><i class="icon-share-alt icon-white"></i>返回</a></td>
						</tr>
					</table>
				</div>
				<!-- /.row -->
	...
	<script type="text/javascript">
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/CRM/Customer/uploadQueryAndModify.do',
			...
			function downloadfile() {
				window.location.href= "../../download/queryAndModify.xls";
			}
