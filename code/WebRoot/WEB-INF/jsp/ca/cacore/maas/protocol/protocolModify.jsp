   ...
   $(document).ready(function() {
	...
	<body>
		<div class="container-fluid">
			...
			<!-- 数据区 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/maas/Protocol/modifyProtocol.do?seq_id=${rmHelper.returnParams.seq_id}" enctype="multipart/form-data" method="POST">
					<!-- 提示信息标签 -->
					...
					<div class="row">
						...
						<webTag:Date id="startdate"  name="startdate"  value='${rmHelper.returnParams.startdate}'  displayLable="生效日期" isdisplay="true"/>
						<webTag:Date id="enddate"    name="enddate"    value='${rmHelper.returnParams.enddate}'    displayLable="终止日期" isdisplay="true"/>
					</div><!-- /.row -->
