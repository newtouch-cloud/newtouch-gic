...
<base target="_self"/>
	...
	<body style="overflow: hidden;">
		<div class="container-fluid" >
			...
			<!-- 查询面板 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm"  onsubmit="return CBSPolicyLifeSave('contractLifeSave');" class="form-horizontal alert alert-info fade in span12" action="" method="POST">
					...
					<div class="row">
					    <webTag:DynamicSelectTag src="insBranchSelect" name="insBranch_id" id="insBranch_id" displayLable="保险公司机构" value="${rmHelper.returnParams.insBranch_id}" isdisplay="true" iclass="required validatePolicyCode getPolicyLifeBySendCode validatePLF"/>
						<webTag:Text id="send_code" name="send_code" value="${rmHelper.returnParams.send_code}" displayLable="投保单号"  isdisplay="true" iclass="required getPolicyLifeBySendCode validatePLF"/>
						<webTag:Text id="policy_code" name="policy_code" value="${rmHelper.returnParams.policy_code}" displayLable="保单号"  isdisplay="true" iclass="required validatePolicyCode"/>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<webTag:Date id="hold_date" name="hold_date" value="${rmHelper.returnParams.hold_date}" displayLable="投保日期" isdisplay="true"  iclass="required checkDateOrder"/>
						<webTag:Date id="validate_date" name="validate_date" value="${rmHelper.returnParams.validate_date}" displayLable="保单生效日期" isdisplay="true"  iclass="required checkDateOrder"/>
					</div>
					<br>
				<div class="dreadcount">
						...
						<tr>                
	                  	...
	                  	<c:forEach items="${rmHelper.returnParams.productListView}" var="product" varStatus="index">
	                    	<tr id="productLlife_${index.index + 1}">
	                  	     ...
	                  	     <td id='coverage_time'>${product.amount}</td>
...
<!-- 按钮放置在标题内的样式 -->
				...
				<div class="Shrinkcontent" id="Shrinkcontent5" >
					<div class="row">
						...
						<webTag:Text id="period_prem_tow" name="period_prem_tow" value="${rmHelper.returnParams.period_prem}" displayLable="首期保费合计确认"  isdisplay="true" iclass="required"/>
					...
					<div class="row">
					 ...
					 <div class="row" style="text-align:right;">
					       <button type="submit" id="button"  onclick="CBSPolicyLifeSave('contractLifeSave');"  class="btn btn-danger"><i class="icon-inbox icon-white"></i>提交</button>
