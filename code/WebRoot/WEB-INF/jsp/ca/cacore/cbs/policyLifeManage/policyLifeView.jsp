...
<base target="_self">
		...
		<div class="container-fluid" >
			<!-- 面包屑导航  start -->
				<div class="dreadcount">
			      ...
			      <span><i class="icon-list icon-red"></i>投保单查询</span><span class="divider">/</span>
			      <span><i class="icon-list icon-red"></i>投保单明细</span>
			</div>
			<!-- 面包屑导航  end -->
			<!-- 查询面板 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm"  onsubmit="return CBSPolicyLifeSave('update');" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/cbs/policyLife/policyLifeUpdate.do" method="POST">
					...
					<div class="row">
						<webTag:Text id="agent_id" name="agent_id" value="${rmHelper.returnParams.agent_id}" displayLable="保单中介人员代码"  isdisplay="true" readonly="true" iclass="required" />
	...
	<!-- 按钮放置在标题内的样式 -->
	            ...
	            <div class="Shrinkcontent" id="Shrinkcontent5" >
					...
					<div class="row">
						<webTag:Text id="bank_accName" name="bank_accName" value="${rmHelper.returnParams.bank_accName}" displayLable="银行开户人" isdisplay="true" readonly="true" iclass="required" />
					...
					<div class="row">
					 ...
					 <div class="row" style="text-align:right;">
					  <a id="viewBack" class="btn btn-danger" href="<%=basePath %>/cbs/policyLifeManage/queryPolicyLife.do"><i class="icon-share-alt icon-white"></i>  返回</a>
					 </div>  	
				 </div>
				</form>
				</div>
