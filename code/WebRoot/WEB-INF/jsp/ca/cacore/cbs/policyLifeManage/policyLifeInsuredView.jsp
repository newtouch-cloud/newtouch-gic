			...
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/FuncButton/funcButtonAdd.do" method="POST">
					...
					<div class="row">
					    ...
					    <webTag:DynamicSelectTag src="applicantRelation2Select" name="relation2" id="relation2" value='${rmHelper.returnParams.relation2}' displayLable="与主被保人关系" isdisplay="true" onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();" readonly="readonly"/>
					</div>
					<div class="row">
						<webTag:Text id="name" name="name" value='${rmHelper.returnParams.name}' displayLable="被保人姓名" isdisplay="true" readonly="true"/>
						<webTag:Text id="name" name="name" value='${rmHelper.returnParams.name}' displayLable="被保人姓名（二录）" isdisplay="true" readonly="true"/>
					</div>
					<div class="row">
					    <webTag:DynamicSelectTag src="certiTypeSelect" name="certi_type" id="certi_type" value='${rmHelper.returnParams.certi_type}' displayLable="被保人证件类型" isdisplay="true" onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();" readonly="readonly"/>
						<webTag:Text id="certi_no" name="certi_no" value='${rmHelper.returnParams.certi_no}' displayLable="被保人证件号码" isdisplay="true" readonly="true"/>
						<webTag:Text id="certi_no_tow" name="certi_no_tow" value='${rmHelper.returnParams.certi_no}' displayLable="被保人证件号码（二录）" isdisplay="true" readonly="true"/>
					</div>
					<div class="row">
						...
						<webTag:Date id="birthday" name="birthday" value='${rmHelper.returnParams.birthday}' displayLable="出生日期" isdisplay="true" readonly="true"/>
					...
					<div class="row">
						<webTag:DynamicSelectTag src="nationSelect"  id="nation" name="nation" value='${rmHelper.returnParams.nation}' isdisplay="true"  displayLable="民族" onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();" readonly="readonly"/>
						<webTag:Text id="homeplace" name="homeplace" value='${rmHelper.returnParams.homeplace}' displayLable="籍贯:" readonly="true"/>
						<webTag:DynamicSelectTag src="maritalSelect" name="marital_stat" id="marital_stat" value='${rmHelper.returnParams.marital_stat}' isdisplay="true" displayLable="婚姻状况" onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();" readonly="readonly"/>
					</div>
					<div class="row">
                        ...
                        <webTag:DynamicSelectTag src="educationSelect" name="education2" id="education2" value='${rmHelper.returnParams.education2}' displayLable="教育程度:" onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();" readonly="readonly"/>
