	...
	<head>
		...
		jQuery.validator.addMethod("validateStatus",function(value,element){
	     	...
	     	if(!isUndefined(bef_status) && !isUndefined(aft_status)){
	     		  //强制类型转换
	     		  if(Number(bef_status) >= Number(aft_status)){
		     		 return false;
		     	   }else{
		     		   return true;
		     	   }
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i>保单状态变更</span><span class="divider">/</span>
			...
			<!-- 数据区 start -->
			<div class="row-fluid">
				<form id= "mainForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/cbs/contractLifeManage/clfStatusModify.do" method="POST">
				   ...
				   <fieldset>
					    ...
					    <div class="row">
					      <webTag:DynamicSelectTag src="contractLifeStatusSelect" name="bef_status" id="bef_status" value="${rmHelper.returnParams.status}" isdisplay="true" displayLable="变更前状态" onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();" readonly="readonly"/>
					      <webTag:DynamicSelectTag src="contractLifeStatusSelect" name="aft_status" id="aft_status" value="" isdisplay="true" displayLable="变更后状态"/>
					    </div>
					    </br>
						</br>
						</br>
					    ...
					    <div class="row" style="text-align:right;">
				    	    ...
				    	    <a class="btn btn-danger" href="<%=basePath %>/cbs/contractLifeManage/queryContractLifeStatus.do"><i class="icon-share-alt icon-white"></i>返回</a>
						</div>
					</fieldset>
				</form>
			</div>
