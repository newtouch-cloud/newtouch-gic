	...
	<body>
		<div class="container-fluid" >
			...
			<div class="dreadcount" >
			    ...
			    <span><i class="icon-list icon-red"></i>保单查询</span><span class="divider">/</span>
			    <span><i class="icon-list icon-red"></i>保单明细</span>
			</div>
			<!-- 面包屑导航  end -->
			
			<!-- 查询面板 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/cbs/contractLife/contractLifeSave.do" method="POST">
					...
					<div class="row">
					    ...
					    <webTag:Text id="policy_code" name="policy_code" value="${rmHelper.returnParams.policy_code}" displayLable="保单号" iclass="required "  isdisplay="true" readonly="true"/>
					</div>
					<div class="row">
	            ...
	            <div class="Shrinkcontent" id="Shrinkcontent5" >
					...
					<div class="row">
					 ...
					 <div class="row" style="text-align:right;">
					    <a id="viewBack" class="btn btn-danger" href="<%=basePath %>/cbs/contractLifeManage/queryContractMaster.do"><i class="icon-share-alt icon-white"></i>  返回</a>
					 </div>
				</div>
				</form>
		</div>
