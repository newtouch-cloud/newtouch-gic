	...
	<body style="overflow: hidden;">
		<div class="container-fluid" >
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i> 保单维护</span><span class="divider">/</span>
			    <span><i class="icon-list icon-red"></i> 保单修改</span>
			</div>
			<!-- 面包屑导航  end -->
			...
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" method="POST">
					...
					<webTag:HiddenInputTag id="seq_id" name="seq_id" value="${rmHelper.returnParams.seq_id}" displayLable="保单的seq_id"/>
					...
					<div class="row">
						...
						<webTag:Text id="send_code" name="send_code" value="${rmHelper.returnParams.send_code}" displayLable="投保单号"  isdisplay="true" iclass="required" readonly="true"/>
						<webTag:Text id="policy_code" name="policy_code" value="${rmHelper.returnParams.policy_code}" displayLable="保单号"  isdisplay="true" iclass="required" readonly="true"/>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<webTag:Date id="validate_date" name="validate_date" value="${rmHelper.returnParams.validate_date}" displayLable="保单生效日期" isdisplay="true"  iclass="required" readonly="true"/>
					</div>
					<br>
				<div class="dreadcount">
				...
				<div class="Shrinkcontent" id="Shrinkcontent5" >
					...
					<div class="row">
					 ...
					 <div class="row" style="text-align:right;">
					     <button type="button" id="policyLifeSave" onclick="CBSPolicyLifeSave('contractLifeUpdate');" class="btn btn-danger"><i class="icon-inbox icon-white"></i>提交</button>
				         <a id="viewPolicyLife" class="btn btn-danger" href="<%=basePath %>/cbs/contractLifeManage/queryContractLifeModify.do"><i class="icon-share-alt icon-white"></i>返回</a>
					</div>
				</form>
			</div>
		</div>
