	...
	<body>
		<div class="container-fluid">
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i>保全问题件明细</span>
			</div>
			<!-- 面包屑导航  end -->
			   ...
			   <table style="width: 100%;height:200px;" class="table table-striped table-bordered bootstrap-datatable datatable">						  
				<tr>
				    ...
				    <div class="row" style="text-align:right;">
					   <a id="viewBack" class="btn btn-danger" href="<%=basePath %>/CBS/PolicyLifeProblem/queryConservationProblem.do"><i class="icon-share-alt icon-white"></i>  返回</a>
					</div>
