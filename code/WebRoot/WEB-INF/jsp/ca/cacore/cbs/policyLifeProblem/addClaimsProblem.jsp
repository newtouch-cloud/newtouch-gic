		...
		<script>
		  ...
		  jQuery.validator.addMethod("queryBranch2",function(value,element){
			 ...
			 function  saveProblem(){
				 if($("#queryForm").valid()){
					 blockUI();
					 document.getElementById("queryForm").action="<%=basePath %>/PolicyLifeProblem/addPolicyLifeProblem.do?flag=3";
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i>理赔问题件录入</span>
			</div>
			<!-- 面包屑导航  end -->
			
			<!-- 数据区 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12"  action="<%=basePath %>/PolicyLifeProblem/addPolicyLifeProblem.do?flag=3" method="POST">
					...
					<div class="row">
						...
						<webTag:DynamicSelectTag src="problemOriginTypeSelect" name="origin_type" id="origin_type" value='3' displayLable="问题件业务来源" isdisplay="true" onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();" readonly="readonly"/>
				    ...
				    <div class="row" style="text-align:right;">
  				         ...
  				         <a class="btn btn-danger" href='<%=basePath %>/CBS/PolicyLifeProblem/queryClaimsProblem.do'><i class="icon-share-alt icon-white"></i>返回</a>
					</div>
				</form>
			</div>
			<!--  数据区 end -->
