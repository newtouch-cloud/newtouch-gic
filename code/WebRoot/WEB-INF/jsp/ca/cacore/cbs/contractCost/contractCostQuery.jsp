...
<html lang="en">
	<head>
		...
		<script >
			var linkUrl = "<%=basePath %>/CBS/contractCost/queryContractCost.do";
	...
	<body>
		<div class="container-fluid" >
			...
			<div class="dreadcount">
				...
				<span><i class="icon-list icon-red"></i> 保单费用明细查询</span>
			...
			<div class="row-fluid" id="Shrinkcontent1">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/CBS/contractCost/queryContractCost.do" method="POST">
				    <div class="row">
