...
<html lang="en">
			 ...
			 //dialog 信息
       	    $("#dialog").dialog({
       	        ...
       	        buttons:[{
       	            text:"是",
       	            click:function(){
       	            		var href = "<%=basePath %>/cbs/policyImage/QueryAddPolicyImage.do";
		       	 			//将查询参数拼接到请求超链接上
	...
	<body>
		<div class="container-fluid" >
			...
			<!-- 查询面板 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" onsubmit="return checkSubmit();" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/CBS/policyImage/concernAddPolicyImage.do" method="POST">
				    ...
				    <div class="row" style="text-align:right;">
				    		...
				    		<a id="aback" class="btn btn-danger" href="<%=basePath %>/cbs/policyImage/QueryAddPolicyImage.do" ><i class="icon-share-alt icon-white"></i>返回</a>
					</div>
				</form>
			</div>
			<!-- 查询面板 end -->
