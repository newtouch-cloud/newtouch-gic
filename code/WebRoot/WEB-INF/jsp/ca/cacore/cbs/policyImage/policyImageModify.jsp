	...
	<body>
		<div class="container-fluid" >
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i> 投保单影像件查询</span><span class="divider">/</span>
				<span><i class="icon-list icon-red"></i> 投保单影像修改</span>
			</div>
			<!-- 面包屑导航  end -->
			<!-- 查询面板 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/cbs/policyImage/modifyPolicyImage.do" method="POST">
				    ...
				    <div class="row" style="text-align:right;">
				    		...
				    		<a  class="btn btn-danger" href="<%=basePath %>/cbs/policyImage/queryPolicyImage.do" ><i class="icon-share-alt icon-white"></i>返回</a>
					</div>
				</form>
			</div>
			<!-- 查询面板 end -->
