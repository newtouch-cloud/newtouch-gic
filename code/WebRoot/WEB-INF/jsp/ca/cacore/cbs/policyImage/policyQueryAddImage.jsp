...
<html lang="en">
	<head>
		...
		<script >
			var linkUrl = "<%=basePath %>/cbs/policyImage/QueryAddPolicyImage.do";
	...
	<body>
		<div class="container-fluid" >
			...
			<div class="row-fluid" id="Shrinkcontent1">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/cbs/policyImage/QueryAddPolicyImage.do" method="POST">
					<div class="row"> <!-- 机构选择 -->
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					...
					<tbody>
						<c:forEach var="cm" items="${rmHelper.returnMsg.dataList}" varStatus="index" >
							<tr>
							    <td>
						    		<a class="btn btn-mini btn-dangerLight" href='<%=basePath %>/cbs/policyImage/addPolicyImage.do?policy_id=${cm.policy_id}'><i class="icon-plus icon-white"></i>影像件上传</a>
							    </td>
							    <td>${index.index+1}</td>
								<td>${cm.branch_id}</td>
