...
//		 		子页面控制父页面高度结束
			 ...
			 //dialog 信息
       	    $("#dialog").dialog({
       	        ...
       	        buttons:[{
       	            text:"是",
       	            click:function(){
       	            		location.href="<%=basePath %>/cbs/contractLife/contactLifeAdd.do"
       	                	$("#dialog").dialog("close");
       	                }
       	            },
       				{
	...
	<body>
		<div class="container-fluid" >
			...
			<!-- 查询面板 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" onsubmit="return checkSubmit();" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/CBS/policyImage/concernContractAddImage.do" method="POST">
