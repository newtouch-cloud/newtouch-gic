...
<div class="container-fluid">
    ...
    <div class="dreadcount">
        <span class=mrl14><i class="icon-list icon-red"></i> 数据导入</span><span class="divider">/</span>
        <span><i class="icon-list icon-red"></i> 保单导入</span>
    ...
    <div class="row-fluid" id="Shrinkcontent1">
        <form id="queryForm" name="queryForm" class="form-horizontal  fade in span12"
              action="<%=basePath%>/PolicyManager/goPolicyList.do" method="POST">
            <!-- 提示信息标签 -->
            ...
            <div class="overAuto row-fluid">
                <table class='table table-striped table-bordered bootstrap-datatable datatable'>
                    <tr>
                        ...
                        <td width="100px" style="vertical-align: middle; text-align: center;"><a id="downloadBtn" class="btn btn-danger" onclick="downloadfile();">
                        ...
                        <td width="100px" style="vertical-align: middle; text-align: center;">
                            <button class="btn btn-danger" type="button" id="ctlBtndaoru"><i
                                    class="icon-upload icon-white"></i>开始导入
                            </button>
                        </td>
                    ...
                    <tr>
                        <td style="vertical-align: middle; text-align: center;"><i
                                class="icon-exclamation-sign icon-red"></i> 导入消息
                        </td>
                        <td colspan="3">
                            <textarea id="upMsg" rows="15" name="upMsg" style="width: 760px;"
                    ...
                    <tr>
                        <td colspan="5" style="vertical-align: middle; text-align: center;">
                            <button class="btn btn-danger" onClick="backBefore();">返回</button>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function downloadfile() {
        window.location.href = "<%=basePath%>/download/policy_model.xls";
    }
    ...
    var uploaderdaoru = WebUploader.create({
        ...
        // 文件接收服务端。
        server: '<%=basePath%>/CBS/policyImport/importInsurance2.do',
