...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="row-fluid" id="Shrinkcontent1">
				<form id="queryForm" name="queryForm" class="form-horizontal  fade in span12" action="<%=basePath%>/PolicyManager/goPolicyList.do" method="POST">
				<!-- 提示信息标签 -->
				...
				<div class="overAuto row-fluid">
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						...
						<tr>
							<td colspan="5" style="vertical-align: middle; text-align: center;"><button class="btn btn-danger" onClick="window.location.href='<%=basePath%>/PolicyManager/goPolicyList.do';;">返回</button></td>
						</tr>
					</table>
				</div>
				<!-- /.row -->
	...
	<script type="text/javascript">
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/CBS/policyImport/importBusiness.do',
