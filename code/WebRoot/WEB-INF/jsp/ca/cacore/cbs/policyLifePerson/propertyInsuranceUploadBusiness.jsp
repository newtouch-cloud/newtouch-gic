...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i>业务类型 数据导入</span>
			...
			<div class="row-fluid" id="Shrinkcontent1">
				<form id="queryForm" name="queryForm" class="form-horizontal  fade in span12" action="<%=basePath%>/PolicyManagerPerson/goPolicyList.do" method="POST">
				<!-- 提示信息标签 -->
				...
				<div class="overAuto row-fluid">
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						...
						<tr>
							<td colspan="5" style="vertical-align: middle; text-align: center;"><button class="btn btn-danger" onClick="window.location.href='<%=basePath%>/PolicyManagerPerson/goPolicyList.do';;">返回</button></td>
						</tr>
					</table>
				</div>
				<!-- /.row -->
	...
	<script type="text/javascript">
			...
			function downloadfile() {
				window.location.href= "<%=basePath%>/download/property_business.xls";
			}
	
			var backBefore1111 = function (){
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/CBS/policyImportPerson/importBusiness.do',
