...
<html lang="en">
			...
			<form id="queryForm" name="queryForm" class="form-horizontal  fade in span12" action="<%=basePath%>/PolicyManagerPerson/goPolicyList.do" method="POST">
				...
				<div class="overAuto row-fluid">
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						...
						<tr>
							<td colspan="5" style="vertical-align: middle; text-align: center;"><button class="btn btn-danger" onClick="backBefore();">返回</button></td>
						</tr>
					</table>
				</div>
				<!-- /.row -->
	...
	<script type="text/javascript">
			...
			function downloadfile() {
				window.location.href= "<%=basePath%>/download/policy_model_person.xls";
			}
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/CBS/policyImportPerson/importInsurance2.do',
