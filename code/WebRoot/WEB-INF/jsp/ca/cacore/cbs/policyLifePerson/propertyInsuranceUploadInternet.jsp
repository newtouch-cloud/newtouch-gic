...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i>互联网标识 数据导入</span>
	...
	<script type="text/javascript">
			function downloadfile() {
				window.location.href= "<%=basePath%>/download/property_inter.xls";
			}
			function backBefore(){
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/CBS/policyImportPerson/importInter.do',
