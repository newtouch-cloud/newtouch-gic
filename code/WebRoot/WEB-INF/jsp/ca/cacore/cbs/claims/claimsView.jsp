		...
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i> 理赔维护</span><span class="divider">/</span>
			     <span><i class="icon-list icon-red"></i> 理赔信息明细</span>
			</div>
			<!-- 面包屑导航  end -->
			...
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12"  action="<%=basePath %>/CBS/Claims/addClaims.do" method="POST">
					...
					<div class="row">
						...
						<webTag:Text id="event_name" name="event_name" value='${rmHelper.returnParams.event_name}' displayLable="出险人" readonly="true" isdisplay="true"/>
						<webTag:Date id="event_date" name="event_date" value='${rmHelper.returnParams.event_date}' displayLable="出险时间" readonly="true" isdisplay="true"/>
					</div>
					
					<div class="row">
						<webTag:DynamicSelectTag src="claimsStatusSelect" name="claims_status" id="claims_status" value='${rmHelper.returnParams.claims_status}' displayLable="出险状态" onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();" readonly="readonly" isdisplay="true"/>
					</div>
					
					<div class="row">
						<webTag:TextareaTag id="event_process" name="event_process" rows='3' value='${rmHelper.returnParams.event_process}' displayLable="出险经过:" readonly="true"/>
					</div>
