...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i> 单证使用等级导入</span>
				...
				<div class="overAuto row-fluid">
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						<tr>
							...
							<td width="100px"  style="vertical-align: middle; text-align: center;" ><a id="downloadBtn" class="btn btn-danger" href="<%=basePath%>/Branch/upload/downloadTemplate.do?file_name=documentTemple.xls" >
						...
						<tr>
							...
							<td colspan="3">
								<textarea id="upMsg" rows="15" name="upMsg" style="width: 760px;" readonly="readonly">
						...
						<tr>
							<td colspan="5" style="vertical-align: middle; text-align: center;"><a class="btn btn-danger" href="<%=basePath %>/DMS/docmanagent.do"><i class="icon-share-alt icon-white"></i>返回</a></td>
						</tr>
					</table>
				</div>
				<!-- /.row -->
	...
	<script type="text/javascript">
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/DMS/importdocmanagent.do',
