			...
			<div class="row-fluid" id="Shrinkcontent1">
				...
				<input type="hidden" id="seq_id" name="seq_id" value='${rmHelper.returnParams.seq_id}' />
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						...
						<tr>
							<td colspan="5" style="vertical-align: middle; text-align: center;"> <a class="btn btn-danger" href="<%=basePath %>/Branch/branchGoModify.do?seq_id=${rmHelper.returnParams.seq_id}"><i class="icon-share-alt icon-white"></i>返回</a></td>
						</tr>
					</table>
				</div>
				<!-- /.row -->
