...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i> 营业执照</span>
				...
				<input type="hidden" id="seq_id" name="seq_id" value='${rmHelper.returnParams.seq_id}' />
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						<tr>
							...
							<td colspan="2" width="250px"   style="vertical-align: middle; text-align: center; background-color:white'' ">
									导入文件列表
							</td>
						</tr>
						...
						<tr>
							<td colspan="5" style="vertical-align: middle; text-align: center;"><a class="btn btn-danger" href="<%=basePath %>/Branch/importRedirect.do?seq_id=${rmHelper.returnParams.seq_id}"><i class="icon-share-alt icon-white"></i>返回</a></td>
						</tr>
					</table>
				</div>
				<!-- /.row -->
	...
	<script type="text/javascript">
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/Branch/importbranchIMgPdf.do?seq_id='+seq_id,
			...
			uploaderdaoru.on('error', function (type) {
			    ...
			    if (type == "Q_EXCEED_NUM_LIMIT") {
			    	$('#upMsg').val("最多支持1个文件");
			    	 ...
			    	 $('#upMsg').val("请上传JPG、PNG、PDF格式文件");
			     } else if (type == "Q_EXCEED_SIZE_LIMIT") {
			    	 $('#upMsg').val("文件大小不能超过2M");
			     }else {
