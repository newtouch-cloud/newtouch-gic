...
<html lang="en">
	<head>
		...
		function uploadimg(){
			...
			location.href="<%=basePath %>/Branch/uploadimg.do?seq_id="+seq_id+"&lurl=ca/cacore/manage/branch/branchYYZZ";
		}
		</script>
	</head>
	<body>
		<div class="container-fluid" >
			...
			<div class="row-fluid">
					...
					<fieldset>
                     ...
                     <div class="row">
						<webTag:Text id="parent_branch_id" name="parent_branch_id" value='${rmHelper.returnParams.parent_branch_id}'  readonly="true" displayLable="上级机构代码" isdisplay="true"/>
						<webTag:Text id="parent_branch_name" name="parent_branch_name" value='${rmHelper.returnParams.parent_branch_name}' readonly="true" displayLable="上级机构名称" isdisplay="true"/>
						<webTag:Text id="branch_level_name" name="branch_level_name" value='${rmHelper.returnParams.branch_level_name}' readonly="true" displayLable="本机构层级" isdisplay="true"/>
					</div><!-- /.row -->
					
					<div class="row">                                    
						<webTag:Text id="branch_id" name="branch_id" value='${rmHelper.returnParams.branch_id}' readonly="true" displayLable="机构编码" isdisplay="true"/>
                        <webTag:Text id="branch_name" name="branch_name" value='${rmHelper.returnParams.branch_name}' readonly="true" displayLable="机构名称" isdisplay="true"/>
                        <webTag:Text id="branch_abbr" name="branch_abbr"  value='${rmHelper.returnParams.branch_abbr}' readonly="true" displayLable="机构简称" isdisplay="true"/>
					</div><!-- /.row -->
					...
					<div class="row">     
                        ...
                        <webTag:Text id="delegate" name="delegate" value='${rmHelper.returnParams.delegate}' readonly="true" displayLable="法人代表:"/>
					...
					<div class="row"> 
                        ...
                        <webTag:Text id="permitcode" name="permitcode" value='${rmHelper.returnParams.permitcode}' readonly="true" displayLable="保监许可机构编码:"/>
                        <webTag:Text id="permitarea" name="permitarea" value='${rmHelper.returnParams.permitarea}' readonly="true" displayLable="区域:"/>
					</div><!-- /.row -->
					...
					<div class="row">
                        ...
                        <webTag:Text id="area" name="area" value='${rmHelper.returnParams.area}' readonly="true" displayLable="县：" />
					</div>
					
					<div class="row">
						<c:if  test="${rmHelper.returnParams.status==0 }">
							<webTag:Text id="status" name="status" value='删除' readonly="true" displayLable="机构状态:" />
	                    </c:if>
	                    ...
	                    <c:if  test="${rmHelper.returnParams.status==2 }">
							<webTag:Text id="status" name="status" value='禁用' readonly="true" displayLable="机构状态:" />
	                    </c:if>
