	...
	<body id="body">
		<div class="container-fluid" >
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i>新增下级机构</span>
			</div>
			<!-- 面包屑导航  end -->
			
			<!--增加面板 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/Branch/insertBranch.do" method="POST">
					<!-- 提示信息 -->
					...
					<div class="row">                                    
                        ...
                        <webTag:Text id="branch_name" name="branch_name" value='${rmHelper.returnParams.branch_name}' displayLable="组织名称" isdisplay="true" readonly="false"/> 
                        <webTag:Text id="branch_abbr" name="branch_abbr"  value='${rmHelper.returnParams.branch_abbr}' displayLable="组织简称" isdisplay="false" readonly="false"/>
					</div><!-- /.row -->
					...
					<div class="row">    
					   <!--  将成立日期修改成营业执照成立日期 by zdd 20190606    -->                   
                        ...
                        <webTag:Text id="delegate" name="delegate" value='${rmHelper.returnParams.delegate}' displayLable="负责人:" readonly="false"/> 
