...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="row-fluid">
				<ul class="breadcrumb">
					<li>功能菜单 <span class="divider">/</span></li>
					<li>菜单修改 <span class="divider">/</span></li>
					<li>修改</li>
				</ul>
			</div>
			<!-- 面包屑导航  end -->
			...
			<!-- 数据区 start -->
			<div class="row-fluid">
				<form class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/FuncMenu/modifyFuncMenu.do" method="POST">
					<!-- 提示信息标签 -->
					...
					<fieldset>
					    ...
					    <div class="row" style="text-align:right;">
					    		<button type="submit" class="btn btn-mini btn-primary"><i class="icon-search icon-white"></i>修改</button>
