...
<html lang="en">
	...
	<body>
		...
		<div class="row-fluid" id="Shrinkcontent1">
			<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath%>/personalPerson/sysbranchcommission.do" method="POST">
				 <!-- 提示信息 -->
				...
				<webTag:HiddenInputTag id="date_flag" name="path" value='M'/>
				...
				<div class="row" >
					...
					<webTag:Select name="person_flag" id="person_flag" value='${rmHelper.returnParams.person_flag}' displayLable="日期">
						<option value="1" selected="selected">财产险</option>
						<option value="2">人身险</option>
					</webTag:Select>
				</div>
