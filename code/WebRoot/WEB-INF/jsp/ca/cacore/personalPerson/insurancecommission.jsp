...
<html lang="en">
	<head>
		...
		<!--重置-->
			...
			var linkUrl = "<%=basePath %>/personalPerson/insurancecommission.do";
			...
			function exportSalesInfo(){
			    $('#queryForm').attr("action","<%=basePath %>/personalPerson/downloadinsurancecommission.do"); //设置action指向导出
			    $('#queryForm').submit();
			    $('#queryForm').attr("action","<%=basePath %>/personalPerson/insurancecommission.do"); //设置action执向查询
			 }
		</script>
	...
	<body>
		<div class="container-fluid" >
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i>寿险险种报表查询</span><span class="divider"></span>
		...
		<div class="row-fluid" id="Shrinkcontent1">
			<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath%>/personalPerson/insurancecommission.do" method="POST" autocomplete="off">
				 <!-- 提示信息 -->
