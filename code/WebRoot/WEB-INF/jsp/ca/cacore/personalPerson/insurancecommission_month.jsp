...
<html lang="en">
	...
	<body>
		...
		<div class="row-fluid" id="Shrinkcontent1">
			<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath%>/personalPerson/insurancecommission.do" method="POST">
				 <!-- 提示信息 -->
