...
<html lang="en">
	<head>
		...
		<!--重置-->
			...
			$(document).ready(function(){
				...
				linkUrl = linkUrl+"?<%=ServletHelper.getHttpRequestQueryString2(request)%>&nowPage=__id__&";
	...
	<body>
		...
		<div class="row-fluid" id="Shrinkcontent1">
			<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath%>/personal/sysbranchcommission.do" method="POST" autocomplete="off">
				 <!-- 提示信息 -->
