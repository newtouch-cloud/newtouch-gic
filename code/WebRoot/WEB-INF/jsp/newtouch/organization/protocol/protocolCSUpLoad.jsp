...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i> 代理协议导入</span>
			...
			<div class="row-fluid" id="Shrinkcontent1">
				...
				<webTag:HiddenInputTag id="protocol_category" name="protocol_category" value='2'/>
	...
	<script type="text/javascript">
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/organization/Protocol/uploadCs.do',
			...
			function downloadfile() {
				window.location.href= "../../download/protocolCsInfo.xls";
			}
