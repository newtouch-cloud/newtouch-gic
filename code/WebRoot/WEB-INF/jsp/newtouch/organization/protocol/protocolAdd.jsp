  ...
  $(document).ready(function() {
	...
	<body style="height: 750px">
		<div class="container-fluid" >
			...
			<!--增加面板 start -->
			<div class="row-fluid">
				<form id="queryForm" name="queryForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/organization/Protocol/addProtocol.do" method="POST" enctype="multipart/form-data" autocomplete="off">
					<!-- 提示信息标签 -->
