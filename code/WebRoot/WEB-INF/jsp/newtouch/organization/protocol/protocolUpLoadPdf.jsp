...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="dreadcount">
			    ...
			    <span><i class="icon-list icon-red"></i> 影像上传</span>
			...
			<div class="row-fluid" id="Shrinkcontent1">
				...
				<input type="hidden" id="seq_id" name="seq_id" value='${rmHelper.returnParams.seq_id}' />
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						...
						<!--  <td rowspan="2">
							...
							<td width="50px">文件名称:	<span>${rmHelper.returnParams.picture_pathName}</span>
							<input type="hidden" id="picture_path" name="picture_path" value='${rmHelper.returnParams.picture_path}' /></td>
							
							<td width="50px"><button class="btn btn-danger"  id="pickerexp" type="button" class="icon-upload icon-white"/>下载文件</td>
						</tr>
	...
	<script type="text/javascript">
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/organization/Protocol/impProtocolPdf.do?seq_id='+seq_id,
			...
			$("#pickerexp").on('click',function(){
				debugger;
				var fileName = $("#picture_path").val();
				if(""!= fileName){
			...
			function downloadfile() {
				window.location.href= "../../download/protocolInfo.xls";
			}
