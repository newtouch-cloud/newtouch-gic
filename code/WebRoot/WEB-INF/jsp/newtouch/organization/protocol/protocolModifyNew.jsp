...
<script type="text/javascript">
		...
		jQuery.validator.addMethod("checkNum1", function(amount, element) {
			 var reg = /^[1-9]+.?[0-9]*/;
			   if(!reg.test(amount)){
			    return false;
			   }else{
			...
			<form id="queryForm" name="queryForm"
				...
				<!-- 	<div class="row" style="margin-left: -30px; margin-right: -40px">				
					...
					<div class="row" style="margin-left:-30px;margin-right:-40px">   
						...
						</div>						<webTag:Text id="bank_name"  name="bank_name"  value='${rmHelper.returnParams.bank_name}' displayLable="代理开户行" />
