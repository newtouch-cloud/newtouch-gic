...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<!-- 数据区 start -->
			<div class="row-fluid">
				<form id="mainForm" name="mainForm" class="form-horizontal alert alert-info fade in span12" action="<%=basePath %>/goUserUpdatePassPage.do" method="POST">
					<!-- 提示信息 -->
					...
					<webTag:HiddenInputTag id="opt_name_login" name="opt_name_login" value='${opt_name_login}' displayLable="用户姓名:"  />
					<webTag:HiddenInputTag id="opt_name_login" name="opt_name_czyz" value='${opt_name_czyz}' displayLable="用户姓名存在验证"  />
					<webTag:HiddenInputTag name="opt_no1" id="opt_no1"  value='${rmHelper.returnParams.opt_no}'/>
					<div class="row">
					...
					<div class="row">
						<webTag:PasswordTag id="opt_password" name="opt_password" value='' displayLable="新密码:"/> 
						<div style="padding-left: 70px;padding-top: 8px;"  id='error_p'></div>
					</div>
					<div class="row">
						<webTag:PasswordTag id="opt_conf_password" name="opt_conf_password" value='' displayLable="新密码确认:" />
...
<!-- 						<button id="xiugai" name="doUserMgmtMdfUser.do" type="button" class="btn btn-default btn-xs">保存</button> -->
					</div>
				</form>
			</div>
		</div>
