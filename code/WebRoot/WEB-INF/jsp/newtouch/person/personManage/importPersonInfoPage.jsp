...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<span class=mrl14><i class="icon-list icon-red"></i> 人员管理 </span><span
				...
				class="icon-list icon-red"></i>导入</span>
			</div>
			<!-- 面包屑导航  end -->
				...
				<div class="overAuto row-fluid">
					<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						<tr>
							...
							<td width="100px"  style="vertical-align: middle; text-align: center;" ><a id="downloadBtn" class="btn btn-danger" href="<%=basePath %>//Person/PersonManage/downloadPersonTemplate.do" >
						...
						<tr>
							...
							<a id="backButton" class="btn btn-danger" href="<%=basePath %>/Person/PersonManage/toQueryPersonInfo.do?pageName=personInfo">返回</a>
							</td>
						</tr>
					</table>
				</div>
	...
	<script type="text/javascript">
			...
			var uploaderdaoru = WebUploader.create({
			    ...
			    // 文件接收服务端。
			    server: '<%=basePath%>/Person/PersonManage/importPersonInfos.do',
